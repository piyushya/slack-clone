...
var talkFreeButton = document.querySelector('.talk-for-free');
var tryFreeButton = document.querySelector('.try-for-free');
var signupEmail = document.querySelector('.signup-w-mail');
var signupGoogle = document.querySelector('.signup-w-google');
...
talkFreeButton.addEventListener('click', function () {
